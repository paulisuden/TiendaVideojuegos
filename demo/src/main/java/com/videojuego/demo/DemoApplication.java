...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * videojuego.setImagen(
		 * "https://cdn.milenio.com/uploads/media/2023/06/06/matematicos-explican-por-que-es.jpg"
		 * );
		 * 
		 ...
		 * videojuego2.
		 * setDescripcion("Super Mario sigue las aventuras del fontanero Mario, por lo general en el ficticio Reino Champiñón."
		 * );
		 ...
		 * videojuego3.
		 * setDescripcion("El objetivo es recorrer el espacio para comer todas las bolas “energizantes” sin ser atrapado por los fantasmas"
		 * );
		 ...
		 * videojuego3.setImagen(
		 * "https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2022/04/pac-man-2682107.jpg?tf=1200x1200"
		 * );
		 * 
